...
export default function QuoteModule() {
 ...
 <button className="w-full py-4 px-6 rounded-xl bg-primary-container hover:bg-primary-fixed text-on-primary-container text-headline-sm font-bold uppercase tracking-wider transition-all transform hover:-translate-y-0.5 shadow-md flex items-center justify-center gap-2" type="submit">
 ...
 <a className="w-full py-3 px-4 bg-[#25D366] hover:bg-[#20ba59] text-white text-headline-sm font-bold rounded-xl text-center block transition-colors shadow" href="https://wa.me/923003472750?text=Hello%20EIRA%20Pakistan%20Sales%20Team%2C%20I%20need%20a%20forklift%20quote." target="_blank">
